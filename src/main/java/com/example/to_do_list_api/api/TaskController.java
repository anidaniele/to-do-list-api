...
public class TaskController {
    ...
    @GetMapping
    public List<TaskResponseDto> getAllTasks(@AuthenticationPrincipal AuthUser authUser) {
        User user = authUser.getUser();
        return taskMapper.toDtoList(service.getAllTasksByUser(user));
    }

    // TODO: instead of Authentication create converter server and pass @AuthenticationPrincipal
    @GetMapping("/{taskId}")
    ...
    // TODO: sita gal reiketu perrasyt su JsonPatch
    @PatchMapping("/{taskId}")
